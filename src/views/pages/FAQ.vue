    ...
    <div class="card-body p-lg-20">
      ...
      <div class="row mb-20">
        ...
        <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
          <!--begin::Title-->
          <h1 class="text-gray-800 fw-bolder mb-4">Buying Product</h1>
          <!--end::Title-->
        ...
        <div class="col-md-6 ps-md-10">
          <!--begin::Title-->
          <h1 class="text-gray-800 fw-bolder mb-4">Installation</h1>
          <!--end::Title-->
      ...
      <div class="row mb-20">
        ...
        <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
          <!--begin::Title-->
          <h1 class="text-gray-800 w-bolder mb-4">User Roles</h1>
          <!--end::Title-->
        ...
        <div class="col-md-6 ps-md-10">
          <!--begin::Title-->
          <h1 class="text-gray-800 fw-bolder mb-4">Reports Generation</h1>
          <!--end::Title-->
