        ...
        >
          ...
          <div class="d-flex flex-stack pt-15">
            ...
            <div>
              ...
              <button
                v-else-if="currentStepIndex !== totalSteps - 1"
                type="submit"
...
import KTStep1 from '@/components/steps/Step1.vue';
import KTStep2 from '@/components/steps/Step2.vue';
import KTStep3 from '@/components/steps/Step3.vue';
import KTStep4 from '@/components/steps/Step4.vue';
import KTStep5 from '@/components/steps/Step5.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      setCurrentPageBreadcrumbs('Wizard', ['Pages', 'Wizard']);
    });
    ...
    const handleStep = handleSubmit((values) => {
      ...
      if (_stepperObj.value?.getPassedStepIndex() === 3) {
        loading.value = true;
        setTimeout(() => {
