<template>
  ...
  <div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_email_preferences" class="collapse show">
      <!--begin::Form-->
      <form class="form" @submit.prevent="saveChanges2()">
        <!--begin::Card body-->
  ...
  setup() {
    ...
    const saveChanges1 = () => {
      if (submitButton1.value) {
        // Activate indicator
        submitButton1.value.setAttribute('data-ms-indicator', 'on');

        setTimeout(() => {
          submitButton1.value?.removeAttribute('data-ms-indicator');
        }, 2000);
      }
    };
    ...
    const saveChanges2 = () => {
      if (submitButton2.value) {
        // Activate indicator
        submitButton2.value.setAttribute('data-ms-indicator', 'on');

        setTimeout(() => {
          submitButton2.value?.removeAttribute('data-ms-indicator');
        }, 2000);
      }
    };
    ...
    const saveChanges3 = () => {
      if (submitButton3.value) {
        // Activate indicator
        submitButton3.value.setAttribute('data-ms-indicator', 'on');

        setTimeout(() => {
          submitButton3.value?.removeAttribute('data-ms-indicator');
        }, 2000);
      }
    };
