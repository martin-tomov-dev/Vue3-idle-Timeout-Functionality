    ...
    <div class="flex-column flex-lg-row-auto w-100 w-xl-325px mb-10">
      ...
      >
        ...
        <div class="card-body pt-0 p-10">
          ...
          <!--begin::Menu-->
          <ul
            class="menu menu-column menu-pill menu-title-gray-700 menu-bullet-gray-300 menu-state-bg menu-state-bullet-primary fw-bolder fs-5 mb-10"
          >
          ...
          <!--begin::Account info-->
          <div
            class="border border-dashed border-gray-300 bg-lighten card-rounded p-6"
          >
            <!--begin::Title-->
