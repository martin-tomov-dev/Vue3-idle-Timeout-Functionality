  ...
  <div :class="widgetClasses" class="card card-flush">
    ...
    <div class="card-header">
      ...
      <div class="card-toolbar">
        <!--begin::Icon-->
        <a
          class="btn btn-sm btn-icon btn-circle btn-icon-success btn-active-light-success"
          href="#"
        ...
        <!--begin::Icon-->
        <a
          class="btn btn-sm btn-icon btn-circle btn-icon-primary btn-active-light-primary"
          href="#"
          data-bs-toggle="modal"
        ...
        <div class="d-flex align-items-center">
          <!--begin::Icon-->
          <a
            class="btn btn-sm btn-icon btn-circle btn-icon-danger btn-active-light-danger"
            href="#"
    ...
    <div class="card-body pt-1">
      <!--begin::Tabs-->
      <ul
        class="nav rounded-pill flex-center bg-light overflow-auto flex-nowrap p-2 mb-8"
      >
        <!--begin::Tab nav-->
          ...
          <div class="mb-7">
            ...
            <div class="overflow-auto mb-10">
              <template v-for="(item, i) in authors1" :key="i">
                <!--begin::Item-->
                <div
                  :class="[i !== authors1.length - 1 && 'mb-7']"
                ...
                >
                  ...
                  <div class="d-flex flex-column min-w-150px me-4">
                    <a
                      href="#"
                      class="fw-boldest text-gray-800 text-hover-primary fs-4"
                      >{{ item.title }}</a
                    >
          ...
          <div class="mb-7">
            ...
            <div class="overflow-auto">
              <template v-for="(item, i) in authors2" :key="i">
                <!--begin::Item-->
                <div
                  :class="[i !== authors2.length - 1 && 'mb-7']"
                  class="d-flex align-items-center"
                >
                  <!--begin::Avatar-->
                  <div class="symbol symbol-40px symbol-circle me-4">
